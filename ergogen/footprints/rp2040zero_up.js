...
module.exports = {
  ...
  body: p => {
    ...
    const pads = `
      ${pad(1, 17.78, -22.86, 2.6, 1.6, 0.3, 0, p.GP0)}
      ${pad(2, 17.78, -20.32, 2.6, 1.6, 0.3, 0, p.GP1)}
      ${pad(3, 17.78, -17.78, 2.6, 1.6, 0.3, 0, p.GP2)}
      ${pad(4, 17.78, -15.24, 2.6, 1.6, 0.3, 0, p.GP3)}
      ${pad(5, 17.78, -12.70, 2.6, 1.6, 0.3, 0, p.GP4)}
      ${pad(6, 17.78, -10.16, 2.6, 1.6, 0.3, 0, p.GP5)}
      ${pad(7, 17.78, -7.62, 2.6, 1.6, 0.3, 0, p.GP6)}
      ${pad(8, 17.78, -5.08, 2.6, 1.6, 0.3, 0, p.GP7)}
      ${pad(9, 17.78, -2.54, 2.6, 1.6, 0.3, 0, p.GP8)}

      ${pad(10, 15.24, -2.33, 1.6, 2.6, 0, 0.3, p.GP9)}
      ${pad(11, 12.70, -2.33, 1.6, 2.6, 0, 0.3, p.GP10)}
      ${pad(12, 10.16, -2.33, 1.6, 2.6, 0, 0.3, p.GP11)}
      ${pad(13, 7.62, -2.33, 1.6, 2.6, 0, 0.3, p.GP12)}
      ${pad(14, 5.08, -2.33, 1.6, 2.6, 0, 0.3, p.GP13)}

      ${pad(15, 2.54, -2.54, 2.6, 1.6, -0.3, 0, p.GP14)}
      ${pad(16, 2.54, -5.08, 2.6, 1.6, -0.3, 0, p.GP15)}
      ${pad(17, 2.54, -7.62, 2.6, 1.6, -0.3, 0, p.GP26)}
      ${pad(18, 2.54, -10.16, 2.6, 1.6, -0.3, 0, p.GP27)}
      ${pad(19, 2.54, -22.86, 2.6, 1.6, -0.3, 0, p.P5V)}
      ${pad(20, 2.54, -20.32, 2.6, 1.6, -0.3, 0, p.GND)}
      ${pad(21, 2.54, -17.78, 2.6, 1.6, -0.3, 0, p.P3V3)}
      ${pad(22, 2.54, -12.70, 2.6, 1.6, -0.3, 0, p.GP28)}
      ${pad(23, 2.54, -15.24, 2.6, 1.6, -0.3, 0, p.GP29)}
    `;
